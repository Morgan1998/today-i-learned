<details>
<summary style="color: #58a6ff;"><b>Promises</b></summary>

<details>
<summary style="color: #ff7b72;"><b>Mockup of what a Promise class would look like in Javascript</b></summary>
...
<h3 style="color: #cca7ef;">Why promises were made?</h3>
Callback hell. With promises, we no longer have to deal with passing ugly callback pyramids to our APIs. 

<h3 style="color: #cca7ef;">Difference between `.then` syntax and `async/await`</h3>
...
<h3 style="color: #cca7ef;">Are most modern promise-based APIs in Node.js just wrappers for old-school callback-based APIs?</h3>
Yep.

<h3 style="color: #cca7ef;">In javascript method chaining, a variable is only assigned to the last returned thing in the chain</h3>
...
<h3 style="color: #cca7ef;">How do the .then callback(s) in the internal `[[PromiseFulfillReactions]]` list actually get executed?</h3>
...
<h3 style="color: #cca7ef;">The magic of await</h3>
...
<details>
<summary style="color: #58a6ff;"><b>try/catch blocks</b></summary>

<h3 style="color: #cca7ef;">When to use them?</h3>
